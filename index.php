...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
                            ...
                            <div class="main_home_slider">
                                <div class="single_home_slider">
                                    <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                        ...
                                        <div class="home_btn">
                                            <a href="choose" class="btn btn-primary">Leer Más</a>
                                        </div>
        ...
        <section id="choose1" class="service">       
            <div class="container">
                <div class="row">
                    ...
                    <div class="main_service_area sections text-center">
                        ...
                        <!-- <div class="col-sm-4"> -->
                            <div class="single_choose_content">
                                ...
                                <p>Somos una plataforma en cuyo objetivo es generar una comunidad entre los productores, consumidores y trabajadores de diferentes actividades ubicados en la zona de Zapotlán El Grande, para relacionar a los productores y motivar a una competencia sana y de producción sustentable, obtener e intercambiar el uso de buenas prácticas en la producción, y también promocionar empleos para los trabajadores agrícolas; esto se espera lograr mediante el uso de todas las herramientas brindadas a través de esta plataforma integral.
                                </p>
                            </div>
                        <!-- </div> -->
                ...
                <div class="row">
                    <div class="main_choose_area sections text-center">
                        ...
                        <div class="main_choose_content">
                            <div class="single_choose_content">
                                <div class="singel_choose_img">
                                    <img src="assets/images/productividad.png" width="75" height="75" alt="" />
                                </div>

                                <h2>Actividades productivas de Zapotlán El Grande</h2>
                                <p>El 6.87% de los habitantes se dedica al sector primario, el 24.37% al sector secundario, el 65.77% al sector terciario y el resto no se especifica. El 34.49% se encuentra económicamente activa. Las principales actividades económicas son: educación, comercio, servicios, industria, agricultura y ganadería.</p>
                                <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo" ><a href="productividad.php">Ver más </a></button>
                ...
                <div class="row">
                    <div class="main_mix_content text-center sections">
                        <div class="head_title">
                            <h2>Nuestra Economia</h2>
                        </div>
                        <div class="main_mix_menu">
                            <ul>
                                <li class="btn btn-primary filter" data-filter="all">2016</li>
                                <li class="btn btn-primary filter" data-filter=".cat1">2017</li>
                                <li class="btn btn-primary filter" data-filter=".cat2">2018</li>
                                <li class="btn btn-primary filter" data-filter=".cat3">2019</li>
                                <li class="btn btn-primary filter" data-filter=".cat4">2020</li>
                            </ul>
                        </div>
                        ...
                        <div id="mixcontent" class="mixcontent">
                            ...
                            <div class="portfolio_btn_area">
                                <a href="" class="btn btn-md">Conocer Más</a>
                            </div>
                            <div class="gap"></div>
                        </div>
                    </div>                     
                    ...
                    <div class="main_about sections">
                        ...
                        <div class="main_about_content_area">
                            <div class="single_about_left_img">
                                <img src="assets/images/lluvia_aguacate.jpg"  alt="" />
                            </div> 
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="main_blog_area text-center sections">
                            <div class="head_title">
                                <h2>Permacultura</h2>
                                <div class="separator"></div>
                                <p>Fomentamos la Permacultura es un sistema de diseño integral que sirve para implementar asentamientos humanos productivos, de forma sostenible, y bellos que respetan la naturaleza</p>
                            </div>
                            ...
                            <div class="blog_btn">
                                <a href="permacultura.php" class="btn btn-primary">VER MÁS INFORMACIÓN</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <li data-target="#quote-carousel" data-slide-to="0" class="active">
                                        <img class="img-responsive " src="assets/images/hass.jpg" alt="">

                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="1">
                                        <img class="img-responsive" src="assets/images/criollo.jpg" alt="">

                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="2">
                                        <img class="img-responsive" src="assets/images/bacon.jpg" alt="">

                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="3">
                                        <img class="img-responsive" src="assets/images/reed.jpg" alt="">

                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="4">
                                        <img class="img-responsive" src="assets/images/pinkerton.jpg" alt="">

                                    </li>
                                    <li data-target="#quote-carousel" data-slide-to="5">
                                        <img class="img-responsive" src="assets/images/gwen.jpg" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4  col-xs-12">
                                <div class="single_widget wow fadeIn" data-wow-duration="800ms">
                                    ...
                                    <ul>
                                        <li><a href=""><i class="fa fa-envelope"></i>aguacate_tech@avochalenge</a></li>
                                        <li><a href=""><i class="fa fa-phone"></i> 0123 456 789 0112</a></li>
                                        <li><a href=""><i class="fa fa-map-marker"></i> Puebla City</a></li>
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="single_widget wow fadeIn" data-wow-duration="800ms">
                                    <h4 class="footer_title">Ultimas Noticias</h4>
                                    <div class="separator4"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="copyright_text">
                                <p class=" wow fadeInRight" data-wow-duration="1s">Made with <i class="fa fa-seedling"></i> by <a href="https://bootstrapthemes.co">Bootstrap Themes</a>2020. All Rights Reserved</p>
                            </div>
                        </div>
